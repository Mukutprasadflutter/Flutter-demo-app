...
class FeedDetail {
    ...
    FeedDetail({this.complexity, this.firstName, this.ingredients, this.instructions, this.lastName, this.name, this.photo, this.preparationTime, this.serves});
    ...
    factory FeedDetail.fromJson(Map<String, dynamic> json) {
        return FeedDetail(
            ...
            instructions: json['instructions'] != null ? (json['instructions'] as List).map((i) => Instruction.fromJson(i)).toList() : null, 
